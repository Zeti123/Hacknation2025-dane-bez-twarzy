...
from document_number_finder import *
...
Mieszkam w Warszawie przy ulicy Długiej 5. Numer karty to np. 4111-1111-1111-1111 a dowód ABC123456
"""
...
result.entities += find_documents_numbers(example_text)
